...
object Mailboxes extends App {
  ...
  val supportTicketLogger =
    system.actorOf(Props[SimpleActor].withDispatcher("support-ticket-dispatcher"))
  ...
  /** Interesting case #2 - control-aware mailbox we'll use UnboundedControlAwareMailbox
    */
